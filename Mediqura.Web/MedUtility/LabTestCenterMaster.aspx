<%@ Page Title="Lab Test Centre" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="LabTestCenterMaster.aspx.cs" Inherits="Mediqura.Web.MedUtility.LabTestCenterMaster" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerpaymenttypemaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabpaymenttypemaster" runat="server" CssClass="Tab2" HeaderText="Test Center Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelpaymentttypemaster">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            <span id="Span2" class="input-group-addon cusspan" runat="server">Center Name <span
                                                style="color: red">*</span></span>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            <span id="Span3" class="input-group-addon cusspan" runat="server">Center Type  <span
                                                style="color: red">*</span></span>
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvTestCenter" runat="server" CssClass="table-hover grid_table result-table"
