<%@ Page Title="Staff Category" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="StaffCategoryMaster.aspx.cs" Inherits="Mediqura.Web.MedUtility.StaffCategoryMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerStaffCategoryMST" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabStaffCategoryMST" runat="server" CssClass="Tab2" HeaderText="Staff Category Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelStaffCategoryMST">
                                <div class="fixeddiv">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3" MaxLength="10"
                                                ID="txtCategorycode"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txtCategorycode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" MaxLength="35"
                                                ID="txtCategorytype"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txtCategorytype" ID="FilteredTextBoxExtender2"
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvCategoryType" runat="server" CssClass="table-hover grid_table result-table"
                                                        OnPageIndexChanging="GvCategoryType_PageIndexChanging" AllowPaging="True"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvCategoryType_RowCommand"
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCategorytype" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("Categorydescp") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
