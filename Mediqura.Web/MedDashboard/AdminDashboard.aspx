<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="Mediqura.Web.MedDashboard.AdminDashboard" %>
            ...
            <div class="col-sm-4">
                ...
                <div class="row">
                    <div class="col-sm-6 padlr2">
                        <div class="dash_bg">
                            <div class="x_content" style="height: 12vh; width: 100%">
                                <asp:Label runat="server" Text="Total Bill Amount"></asp:Label>
                                <br />
                                <asp:Label ID="lbl_totalbillamount" CssClass="num_size" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 padlr2">
                        <div class="dash_bg">
                            <div class="x_content" style="height: 12vh; width: 100%">
                                <asp:Label runat="server" Text="Total Collected Amount"></asp:Label>
                                <br />
                                <asp:Label ID="lbl_totalcollectedamount" CssClass="num_size" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6 padlr2">
                        <div class="dash_bg">
                            <div class="x_content" style="height: 12vh; width: 100%">
                                ...
                                <br />
                                <asp:Label ID="lbl_totaldueamount" CssClass="num_size" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 padlr2">
                        <div class="dash_bg">
                            <div class="x_content" style="height: 12vh; width: 100%">
                                <asp:Label runat="server" Text="Today's Collected Amount"></asp:Label>
                                <br />
                                <asp:Label ID="lbl_dailycollectedamount" CssClass="num_size" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-6 padlr2">
                        <div class="dash_bg">
                            <div class="x_content" style="height: 13vh; width: 100%">
                                <asp:Label runat="server" Text="Today's Due Amount"></asp:Label>
                                <br />
                                <asp:Label ID="lbl_dailydueamount" CssClass="num_size" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 padlr2">
