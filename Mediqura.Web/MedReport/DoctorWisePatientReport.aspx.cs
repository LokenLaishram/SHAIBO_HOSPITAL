...
{
    public partial class DoctorWisePatientReport : BasePage
    {
        ...
        protected void bindgrid(int page)
        {
            try
            {
                ...
                //if (ddldepartment.SelectedIndex == 0)
                //{
                //    Messagealert_.ShowMessage(lblmessage2, "Department", 0);
                //    div3.Visible = true;
                //    div3.Attributes["class"] = "FailAlert";
                //    ddldepartment.Focus();
                //    return;
                ...
                //{
                //    Messagealert_.ShowMessage(lblmessage2, "Doctor", 0);
                //    div3.Visible = true;
                //    div3.Attributes["class"] = "FailAlert";
                //    ddl_doctor.Focus();
                //    return;
        ...
        public List<AdmissionData> GetAdmissionList(int curIndex)
        {
            ...
            objpat.DocID= Convert.ToInt32(ddl_doctor.SelectedValue == "" ? "0" : ddl_doctor.SelectedValue);
            objpat.DateFrom = from;
            objpat.DateTo = To;
            objpat.PatientType = Convert.ToInt32(ddl_patient_type.SelectedValue == "" ? "0" : ddl_patient_type.SelectedValue);
            return objbillingBO.GetAdmissionListDoctorWise(objpat);
        }
        ...
        public void ExportToPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=DoctorWiseAdmissionlist.pdf");
        ...
        protected void ExportoExcel()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=DoctorWiseAdmissionlist.xlsx");
