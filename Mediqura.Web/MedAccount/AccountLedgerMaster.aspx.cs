...
{
    public partial class AccountLedgerMaster : BasePage
    {
        ...
        protected void bindgrid()
        {
            try
            {
                ...
                List<AccountLedgerMasterData> LedgerList = GetLedgerData(0);
        ...
        public List<AccountLedgerMasterData> GetLedgerData(int curIndex)
        {
            IFormatProvider option = new System.Globalization.CultureInfo("en-GB", true);
            AcountLedgerData objdata = new AcountLedgerData();
            AccountBO objstdBO = new AccountBO();
        ...
        {
            List<AccountLedgerMasterData> LedData = GetLedgerData(0);
            List<AccountLedgerMasterDataExcel> ListexcelData = new List<AccountLedgerMasterDataExcel>();
            int i = 0;
            foreach (AccountLedgerMasterData row in LedData)
            {
                AccountLedgerMasterDataExcel Ecxeclpat = new AccountLedgerMasterDataExcel();
        ...
        protected void btnSync_Click(object sender, EventArgs e)
        {
            ...
            {
                lblmessage.Visible = false;
                List<AccountLedgerMasterData> Listobjdata = new List<AccountLedgerMasterData>();
                foreach (GridViewRow row in GVLedger.Rows)
                {
                    ...
                    AccountLedgerMasterData objsubdata = new AccountLedgerMasterData();
                ...
                string xml = XmlConvertor.LedgerDatatoXML(Listobjdata).ToString();
