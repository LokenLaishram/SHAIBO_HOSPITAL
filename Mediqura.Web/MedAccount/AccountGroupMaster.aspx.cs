...
{
    public partial class AccountGroupMaster : BasePage
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AcountData objdata = new AcountData();
        ...
        protected void bindgrid()
        {
            try
            {
                ...
                List<AccountGroupMasterData> GroupList = GetGroupData(0);
        ...
        public List<AccountGroupMasterData> GetGroupData(int curIndex)
        {
        ...
        {
            List<AccountGroupMasterData> GrpData = GetGroupData(0);
            List<AccountGroupMasterDataExcel> ListexcelData = new List<AccountGroupMasterDataExcel>();
            int i = 0;
            foreach (AccountGroupMasterData row in GrpData)
            {
                AccountGroupMasterDataExcel Ecxeclpat = new AccountGroupMasterDataExcel();
        ...
        protected void btnSync_Click(object sender, EventArgs e)
        {
            ...
            {
                lblmessage.Visible = false;
                List<AccountGroupMasterData> Listobjdata = new List<AccountGroupMasterData>();
                foreach (GridViewRow row in GVGroup.Rows)
                {
                    ...
                    if (Convert.ToInt32(lblGroupType.Text) == 0)
                    {
                        ...
                        AccountGroupMasterData objsubdata = new AccountGroupMasterData();
                ...
                string xml = XmlConvertor.GroupDatatoXML(Listobjdata).ToString();
