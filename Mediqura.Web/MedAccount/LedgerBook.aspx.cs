...
{
    public partial class LedgerBook :BasePage
    {
        ...
        {
            List<LedgerBookData> LedgerExcel = GetLedgerList(0);
            List<LedgerBookMasterDataExcel> ListexcelData = new List<LedgerBookMasterDataExcel>();
            int i = 0;
            foreach (LedgerBookData row in LedgerExcel)
            {
                LedgerBookMasterDataExcel ExcelSevice = new LedgerBookMasterDataExcel();

                ExcelSevice.GroupName = LedgerExcel[i].GroupName;
                ExcelSevice.Ledgername = LedgerExcel[i].Ledgername;
                ExcelSevice.Amount = LedgerExcel[i].Amount;
