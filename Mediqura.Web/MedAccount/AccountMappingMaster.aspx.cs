...
{
    public partial class AccountMappingMaster : BasePage
    {
        ...
        protected void bindgrid()
        {
            try
            {
                ...
                List<AccountMappingMasterData> MappingList = GetMappingData(0);
        ...
        public List<AccountMappingMasterData> GetMappingData(int curIndex)
        {
        ...
        {
            List<AccountMappingMasterData> GrpData = GetMappingData(0);
            List<AccountMappingMasterExcelData> ListexcelData = new List<AccountMappingMasterExcelData>();
            int i = 0;
            foreach (AccountMappingMasterData row in GrpData)
            {
                AccountMappingMasterExcelData Ecxeclpat = new AccountMappingMasterExcelData();
