...
{
    public partial class GENRackMST : BasePage
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                GENRackMasterData objdMasterData = new GENRackMasterData();
                GENRackMasterBO objMasterBO = new GENRackMasterBO();
        ...
        protected void GvRackType_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Edits")
                {
                    ...
                    GENRackMasterData objBlockMasterData = new GENRackMasterData();
                    GENRackMasterBO objBlockMasterBO = new GENRackMasterBO();
                    ...
                    List<GENRackMasterData> GetResult = objBlockMasterBO.GetRackTypeDetailsByID(objBlockMasterData);
                ...
                if (e.CommandName == "Deletes")
                {
                    ...
                    GENRackMasterBO objBlockMasterBO1 = new GENRackMasterBO();
        ...
        private void bind_grid()
        {
            try
            {
                ...
                List<GENRackMasterData> lstemp = GetRackType(0);
        ...
        private List<GENRackMasterData> GetRackType(int p)
        {
            GENRackMasterData objFloorMasterData = new GENRackMasterData();
            GENRackMasterBO objBlockMasterBO = new GENRackMasterBO();
        ...
        private void ExportToPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=StoreRackTypeDetails.pdf");
        ...
        protected void ExportoExcel()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=StoreRackTypeDetails.xlsx");
        ...
        {
            List<GENRackMasterData> TypeDetails = GetRackType(0);
