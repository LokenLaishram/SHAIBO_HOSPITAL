...
{
    public partial class GenLookAlikeMST : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          protected void btnsave_Click(object sender, EventArgs e)
         {
            try
           {
                ...
                GenAlikeBO objBO = new GenAlikeBO();
                ...
                int result = objBO.UpdateGenLookAlikeDetails(objData);
          ...
          protected void GvLabMethodType_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Edits")
                {
                    ...
                    List<AlikeData> GetResult = objBO.GetGenLookAlikeDetailsByID(objData);
                ...
                if (e.CommandName == "Deletes")
                {
                    ...
                    GenAlikeBO objBO1 = new GenAlikeBO();
                    int Result = objBO1.DeleteGenLookDetailsByID(objData);
                    if (Result == 1)
                    {
        ...
        private void bindgrid(int page)
        {
            try
            {
                ...
                List<AlikeData> lstemp = GetLookAlikeDetails(page);
        ...
        private List<AlikeData> GetLookAlikeType(int p)
        {
            AlikeData objData = new AlikeData();
            GenAlikeBO objBO = new GenAlikeBO();
            ...
            objData.Descriptions = txtdesc.Text == "" ? "" : txtdesc.Text;
             objData.IsActive = ddlstatus.SelectedValue == "0" ? true : false;
             return objBO.SearchLookAlikeType(objData);
        }
        ...
        private void ExportToPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    GvLabMethodType.DataSource = GetLookAlikeType(0);
                    GvLabMethodType.DataBind();
        ...
        {
            List<AlikeData> MethodTypeDetails = GetLookAlikeType(0);
        ...
        private List<AlikeData> GetLookAlikeDetails(int p)
        {
            AlikeData objData = new AlikeData();
            GenAlikeBO objBO = new GenAlikeBO();
            objData.Code = txtcode.Text == "" ? "" : txtcode.Text;
            ...
            return objBO.SearchLookAlikeDetails(objData);
        }
