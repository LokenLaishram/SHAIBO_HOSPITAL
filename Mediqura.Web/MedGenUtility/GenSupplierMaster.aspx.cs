    ...
    public partial class SupplierMaster : BasePage
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                GenSupplierTypeMasterData objSupplierTypeMasterData = new GenSupplierTypeMasterData();
                GenSupplierTypeMasterBO objSupplierTypeMasterBO = new GenSupplierTypeMasterBO();
                ...
                objSupplierTypeMasterData.SupplierAddress = txt_address.Text == "" ? null : txt_address.Text;
                objSupplierTypeMasterData.ContactNo = txt_contactno.Text == "" ? null : txt_contactno.Text;
        ...
        protected void GvSupplierType_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Edits")
                {
                    ...
                    GenSupplierTypeMasterData objDepartmentTypeMasterData = new GenSupplierTypeMasterData();
                    GenSupplierTypeMasterBO objDepartmentTypeMasterBO = new GenSupplierTypeMasterBO();
                    ...
                    List<GenSupplierTypeMasterData> GetResult = objDepartmentTypeMasterBO.GetSupplierTypeDetailsByID(objDepartmentTypeMasterData);
                    if (GetResult.Count > 0)
                    {
                        ...
                        txt_address.Text = GetResult[0].SupplierAddress.ToString();
                ...
                if (e.CommandName == "Deletes")
                {
                    ...
                    GenSupplierTypeMasterBO objDepartmentTypeMasterBO1 = new GenSupplierTypeMasterBO();
        ...
        private void bindgrid(int page)
        {
            try
            {
                ...
                List<GenSupplierTypeMasterData> lstemp = GetSupplierType(page);
        ...
        private List<GenSupplierTypeMasterData> GetSupplierTypeExcel(int p)
        {
            GenSupplierTypeMasterData objDepartmentTypeMasterData = new GenSupplierTypeMasterData();
            GenSupplierTypeMasterBO objDepartmentTypeMasterBO = new GenSupplierTypeMasterBO();
            ...
            objDepartmentTypeMasterData.ContactNo = txt_contactno.Text == "" ? "" : txt_contactno.Text;
        ...
        private List<GenSupplierTypeMasterData> GetSupplierType(int p)
        {
            GenSupplierTypeMasterData objDepartmentTypeMasterData = new GenSupplierTypeMasterData();
            GenSupplierTypeMasterBO objDepartmentTypeMasterBO = new GenSupplierTypeMasterBO();
            objDepartmentTypeMasterData.SupplierTypeCode = txt_suppliercode.Text == "" ? "" : txt_suppliercode.Text;
        ...
        private void ExportToPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    GvSupplierType.Columns[9].Visible = false;
        ...
        {
            List<GenSupplierTypeMasterData> SupplierTypeDetails = GetSupplierTypeExcel(0);
            List<GenSupplierDatatoExcel> ListexcelData = new List<GenSupplierDatatoExcel>();
            int i = 0;
            foreach (GenSupplierTypeMasterData row in SupplierTypeDetails)
            {
                GenSupplierDatatoExcel ExcelSevice = new GenSupplierDatatoExcel();
                ...
                ExcelSevice.SupplierAddress = SupplierTypeDetails[i].SupplierAddress;
