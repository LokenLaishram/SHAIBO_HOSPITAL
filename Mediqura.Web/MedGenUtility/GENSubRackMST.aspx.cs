...
{
    public partial class GENSubRackMST :BasePage
    {
        ...
        private void bindddl()
        {
            ...
            ddl_store.Attributes["disabled"] = "disabled";
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                GENRackMasterData objitemsubgroupData = new GENRackMasterData();
                GENRackMasterBO objitemsubgroupBO = new GENRackMasterBO();
        ...
        protected void GvSubRackType_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Edits")
                {
                    ...
                    GENRackMasterData objData = new GENRackMasterData();
                    GENRackMasterBO objBO = new GENRackMasterBO();
                    ...
                    List<GENRackMasterData> GetResult = objBO.GetItemSubRackTypeDetailsByID(objData);
                ...
                if (e.CommandName == "Deletes")
                {
                    ...
                    GENRackMasterData objItemSubGroupTypeMasterData = new GENRackMasterData();
                    GENRackMasterBO objItemTypeMasterBO = new GENRackMasterBO();
                    int i = Convert.ToInt16(e.CommandArgument.ToString());
                    GridViewRow gr = GvSubRackType.Rows[i];
                    Label ID = (Label)gr.Cells[0].FindControl("lblsubrackid");
                    ...
                    GENRackMasterBO objItemSubGroupTypeMasterBO1 = new GENRackMasterBO();
        ...
        private void bindgrid()
        {
            try
            {
                List<GENRackMasterData> lstemp = GetSubRackType(0);
                if (lstemp.Count > 0)
                {
        ...
        private List<GENRackMasterData> GetSubRackType(int p)
        {
            GENRackMasterData objData = new GENRackMasterData();
            GENRackMasterBO objBO = new GENRackMasterBO();
        ...
        private void ExportToPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=StoreSubRackDetails.pdf");
        ...
        protected void ExportoExcel()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=StoreSubRackDetails.xlsx");
        ...
        {
            List<GENRackMasterData> TypeDetails = GetSubRackType(0);
            List<GENSubRackMasterDatatoExcel> ListexcelData = new List<GENSubRackMasterDatatoExcel>();
            int i = 0;
            foreach (GENRackMasterData row in TypeDetails)
            {
                GENSubRackMasterDatatoExcel ExcelSevice = new GENSubRackMasterDatatoExcel();
                ...
                ExcelSevice.AddedDate = TypeDetails[i].AddedDate;
                GvSubRackType.Columns[6].Visible = false;
                GvSubRackType.Columns[7].Visible = false;
                GvSubRackType.Columns[8].Visible = false;
