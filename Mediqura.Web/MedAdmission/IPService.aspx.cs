...
{
    public partial class IPService : BasePage
    {
        ...
        private void bindddl()
        {
            ...
            Commonfunction.PopulateDdl(ddldepartment, mstlookup.GetLookupsList(LookupName.IPDepartment));
        ...
        protected void txt_autoipno_TextChanged(object sender, EventArgs e)
        {
            ...
            IPServiceRecordData Objpaic1 = new IPServiceRecordData();
            IPServiceRecordBO objInfoBO1 = new IPServiceRecordBO();
            List<IPServiceRecordData> getResult1 = new List<IPServiceRecordData>();
            Objpaic1.IPNo = txt_autoipno.Text.Trim() == "" ? "" : txt_autoipno.Text.Trim();
            getResult1 = objInfoBO1.GetDepartmentByIPNo(Objpaic1);
            if (getResult1.Count > 0)
            {
                ddldepartment.SelectedValue = getResult1[0].DepartmentID.ToString();
                ddldoctor.SelectedValue = getResult1[0].DoctorID.ToString();
            }
        ...
        protected void txtservices_TextChanged(object sender, EventArgs e)
        {
            ...
            if (source.Contains(":"))
            {
                ...
                if (result.Count > 0)
                {
                    txtservicecharge.Text = Commonfunction.Getrounding(result[0].LabServiceCharge.ToString());
        ...
        protected void btnadd_Click(object sender, EventArgs e)
        {
            ...
            {
                Messagealert_.ShowMessage(lblmessage, "Please enter Charges.", 0);
                div1.Visible = true;
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            {
                Messagealert_.ShowMessage(lblmessage, "Please enter IPNo.", 0);
                div1.Visible = true;
                div1.Attributes["class"] = "FailAlert";
                txt_autoipno.Focus();
                return;
            ...
            try
            {
                ...
                objrec.RefferaDocID = Convert.ToInt32(ddldepartment.SelectedValue == "" ? "0" : ddldepartment.SelectedValue);
                ...
                int result = objiprecBO.UpdateIPServiceRecord(objrec);
                if (result > 0)
                {
        ...
        protected void btnreset_Click(object sender, EventArgs e)
        {
            ...
            ddldepartment.SelectedIndex = 0;
            MasterLookupBO mstlookup = new MasterLookupBO();
            Commonfunction.PopulateDdl(ddldoctor, mstlookup.GetDoctorBydepartmentID(Convert.ToInt32(ddldepartment.SelectedValue)));
            ddldoctor.SelectedItem.Text = "";
        ...
        protected void txt_patientNames_TextChanged(object sender, EventArgs e)
        {
        ...
        //    objpat.IPNo = txtautoIPNo.Text == "" ? "0" : txtautoIPNo.Text;
        //    objpat.PatientName = txt_patientNames.Text == "" ? null : txt_patientNames.Text.Trim();
        //    //   objpat.DischargeStatus = Convert.ToInt32(ddl_dischargestatus.SelectedValue == "" ? "0" : ddl_dischargestatus.SelectedValue);
        ...
        //            Label netservicecharge = (Label)gr.Cells[0].FindControl("lblnetservicecharge");
