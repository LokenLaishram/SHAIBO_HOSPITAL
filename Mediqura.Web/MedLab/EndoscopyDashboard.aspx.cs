...
{
    public partial class EndoscopyDashboard : BasePage
    {
        ...
        public static List<string> GetLabServices(string prefixText, int count, string contextKey)
        {
            ...
            getResult = objInfoBO.GetEndosTestName(Objpaic);
            List<String> list = new List<String>();
            for (int i = 0; i < getResult.Count; i++)
            {
        ...
        private void bindgrid()
        {
            try
            {
                ...
                List<InvDashboardMasterData> lstemp = GetEndosDetails(0);
        ...
        private List<InvDashboardMasterData> GetEndosDetails(int p)
        {
            ...
            return objitemMasterBO.GetEndosDetails(objItemMasterData);
        }
