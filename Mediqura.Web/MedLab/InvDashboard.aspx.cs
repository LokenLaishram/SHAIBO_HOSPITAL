...
{
    public partial class InvDashboard : BasePage
    {
        ...
        private void bindgrid()
        {
            try
            {
                ...
                List<InvDashboardMasterData> lstemp = GetInvestigationDetails(0);
        ...
        private List<InvDashboardMasterData> GetInvestigationDetails(int p)
        {
            ...
            objItemMasterData.UHID = Convert.ToInt64(txtUHID.Text == "" ? "0" : txtUHID.Text);
            objItemMasterData.InvNo = txt_invno.Text.Trim() == "" ? "" : txt_invno.Text.Trim();
            objItemMasterData.PatientName = txtname.Text.Trim() == "" ? "" : txtname.Text.Trim();
            ...
            return objitemMasterBO.GetInvestigationDetails(objItemMasterData);
        }
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (urgency.Text == "0" || urgency.Text == "1")
                    {
                        ...
                        Invnymber.ForeColor = Color.FromName("#FFFFFF");
                    }
                    if (urgency.Text == "2")
                    {
                        e.Row.Cells[2].BackColor = System.Drawing.Color.Yellow;
                        Invnymber.ForeColor = Color.FromName("#000");
                    }
                    if (urgency.Text == "3")
                    {
        ...
        protected void GvInvestigation_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "View")
                {
                    ...
                    {
                        string url = "../MedLab/RadioReportSample.aspx?id=" + Convert.ToInt64(ID.Text) + "&billID=" + Convert.ToInt64(BillID.Text);
