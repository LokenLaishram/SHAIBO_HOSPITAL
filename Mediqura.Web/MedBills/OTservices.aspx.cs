...
{
    public partial class OTservices : BasePage
    {
        ...
        public static List<string> GetIPNo(string prefixText, int count, string contextKey)
        {
            ...
            getResult = objInfoBO.getOTIPNo(Objpaic);
        ...
        public void loadIp() {
            ...
            getResult = objInfoBO.GetotPatientDetailsByIPNo(Objpaic);
        ...
        protected void btnadd_Click(object sender, EventArgs e)
        {
            ...
            ObjService.Quantity = Convert.ToInt32(txtquantity.Text == "" ? "1" : txtquantity.Text);
        ...
        protected DataTable GetDatafromDatabase()
        {
            ...
            foreach (IPServiceRecordData row in ServiceDetails)
            {
                ...
                Ecxeclpat.ServiceNumber = ServiceDetails[i].ServiceNumber;
                Ecxeclpat.InvNumber = ServiceDetails[i].InvNumber;
        ...
        public void ExportToPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=OTServiceRecordDetails.pdf");
        ...
        protected void ExportoExcel()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=OTServiceRecordDetails.xlsx");
