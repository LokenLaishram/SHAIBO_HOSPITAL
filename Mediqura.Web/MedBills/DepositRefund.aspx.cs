...
{
    public partial class DepositRefund : BasePage
    {
        ...
        protected void txtUHID_TextChanged(object sender, EventArgs e)
        {
            ...
            getResult = objInfoBO.GetPatientDepositDetailByUHID(Objpaic);
            if (getResult.Count > 0)
            {
                ...
                txttotaladjusted.Text = Commonfunction.Getrounding(getResult[0].AdustedAmount.ToString());
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                objrefund.BillNo = System.DateTime.Now.ToString();
        ...
        protected void bindgrid()
        {
            try
            {
                List<RefundData> objdeposit = GetRefundList(0);
        ...
        public List<RefundData> GetRefundList(int curIndex)
        {
            ...
            objbill.UHID = Convert.ToInt64(txtautoUHID.Text == "" ? "0" : txtautoUHID.Text);
            ...
            objbill.DateTo = To;
            return RefundBO.GetRefundList(objbill);
        }
        ...
        protected void gvdepositlist_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Deletes")
                {
                    ...
                    int Result = RefundBO.DeleteRefundByID(objbill);
                    if (Result == 1)
                    {
        ...
        {
            List<RefundData> DepositDetails = GetRefundList(0);
        ...
        public void ExportToPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    gvrefundlist.Columns[5].Visible = false;
                    gvrefundlist.Columns[6].Visible = false;
                    gvrefundlist.Columns[7].Visible = false;
