...
{
    public partial class PhrPaymentDueCollection : BasePage
    {
        ...
        protected void bindgrid()
        {
            try
            {
                ...
                {
                    Messagealert_.ShowMessage(lblmessage, "CustomerType", 0);
                    divmsg1.Attributes["class"] = "FailAlert";
                    divmsg1.Visible = true;
                ...
                List<PhrDueCollectionData> objresult = GetDueCustomerList(0);
        ...
        private List<PhrDueCollectionData> GetDueCustomerList(int p)
        {
            PhrDueCollectionData obdue = new PhrDueCollectionData();
            PhrDueCollectionBO objBO = new PhrDueCollectionBO();
        ...
        protected void gvDueCustomer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Select")
                {
                    ...
                    PhrDueCollectionData objcondemn = new PhrDueCollectionData();
                    PhrDueCollectionBO objstdBO = new PhrDueCollectionBO();
        ...
        {
            PhrDueCollectionData objbill = new PhrDueCollectionData();
            PhrDueCollectionBO objstdBO = new PhrDueCollectionBO();
            objbill.BillNo = BillNo.Trim();
            objbill.PatientTypeID = Convert.ToInt32(Ptype);
            List<PhrDueCollectionData> List = new List<PhrDueCollectionData>();
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                PhrDueCollectionData ObjDue = new PhrDueCollectionData();
                PhrDueCollectionBO objBO = new PhrDueCollectionBO();
                ...
                List<PhrDueCollectionData> results = objBO.UpdatePhrDueCollection(ObjDue);
        ...
        {
            PhrDueCollectionData Objdc = new PhrDueCollectionData();
            PhrDueCollectionBO objmedBO = new PhrDueCollectionBO();
            List<PhrDueCollectionData> getResult = new List<PhrDueCollectionData>();
        ...
        protected void Tab3bindgrid()
        {
            try
            {
                ...
                {
                    Messagealert_.ShowMessage(lbl_message3, "CustomerType", 0);
                    divmsg3.Attributes["class"] = "FailAlert";
                    divmsg3.Visible = true;
                ...
                List<PhrDueCollectionData> objresults = GetDueCollectionList(0);
        ...
        private List<PhrDueCollectionData> GetDueCollectionList(int p)
        {
            PhrDueCollectionData obdue = new PhrDueCollectionData();
            PhrDueCollectionBO objBO = new PhrDueCollectionBO();
            ...
            try
            {
                if (e.CommandName == "Deletes")
                {
                    if (LogData.RoleID == 1 || LogData.RoleID == 40)
                    {
                        ...
                        PhrDueCollectionData objData = new PhrDueCollectionData();
                        PhrDueCollectionBO objDrgBO = new PhrDueCollectionBO();
                        int i = Convert.ToInt16(e.CommandArgument.ToString());
