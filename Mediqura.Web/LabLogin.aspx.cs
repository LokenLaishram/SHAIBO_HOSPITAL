...
namespace Mediqura.Web
{
    public partial class LabLogin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //ExpiryDate = Convert.ToDateTime("2026/08/28 12:00:00");
            ExpiryDate = Convert.ToDateTime("2026/09/02 12:00:00");
            if ((ExpiryDate - Today).TotalDays <= 30)
            {
                lblmessage.Visible = true;
                lblmessage.Text = "Mediqura Lab Licence only: " + Math.Ceiling((ExpiryDate - Today).TotalDays) + " days remaining";
