...
{
    public partial class SoundAlikeMST : BasePage
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
         {
            try
           {
                ...
                if (txtdesc.Text == "")
                {
                    Messagealert_.ShowMessage(lblmessage, "Please enter descriptions.", 0);
                    divmsg1.Visible = true;
                    divmsg1.Attributes["class"] = "FailAlert";
                ...
                AlikeData objData = new AlikeData();
                PhrAlikeBO objBO = new PhrAlikeBO();
                objData.Code = txtcode.Text == "" ? null : txtcode.Text;
                objData.Descriptions = txtdesc.Text == "" ? null : txtdesc.Text;
                ...
                int result = objBO.UpdatePhrSoundAlikeDetails(objData);
        ...
        protected void GvLabMethodType_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Edits")
                {
                    ...
                    List<AlikeData> GetResult = objBO.GetPhrSoundAlikeDetailsByID(objData);
                    if (GetResult.Count > 0)
                    {
                        txtcode.Text = GetResult[0].Code;
                        txtdesc.Text = GetResult[0].Descriptions;
                ...
                if (e.CommandName == "Deletes")
                {
                    ...
                    PhrAlikeBO objBO1 = new PhrAlikeBO();
                    int Result = objBO1.DeletePhrSoundDetailsByID(objData);
                    if (Result == 1)
                    {
        ...
        private void bindgrid(int page)
        {
            try
            {
                ...
                List<AlikeData> lstemp = GetSoundAlikeDetails(page);
        ...
        private List<AlikeData> GetSoundAlikeType(int p)
        {
            AlikeData objData = new AlikeData();
            PhrAlikeBO objBO = new PhrAlikeBO();
            objData.Code = txtcode.Text == "" ? "" : txtcode.Text;
            objData.Descriptions = txtdesc.Text == "" ? "" : txtdesc.Text;
             objData.IsActive = ddlstatus.SelectedValue == "0" ? true : false;
             return objBO.SearchPhrSoundAlikeType(objData);
        }
        ...
        private void ExportToPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    GvLabMethodType.DataSource = GetSoundAlikeType(0);
                    GvLabMethodType.DataBind();
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=LookAlikeDetails.pdf");
        ...
        protected void ExportoExcel()
        {
            ...
            {
                wb.Worksheets.Add(dt, "Look alike Type Detail List");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;filename=LookAlikeDetails.xlsx");
        ...
        {
            List<AlikeData> MethodTypeDetails = GetSoundAlikeType(0);
            List<AlikeDatatoExcel> ListexcelData = new List<AlikeDatatoExcel>();
            int i = 0;
            foreach (AlikeData row in MethodTypeDetails)
            {
                AlikeDatatoExcel ExcelSevice = new AlikeDatatoExcel();
                ExcelSevice.ID = MethodTypeDetails[i].ID;
                ExcelSevice.Code = MethodTypeDetails[i].Code;
                ExcelSevice.Descriptions = MethodTypeDetails[i].Descriptions;
        ...
        private List<AlikeData> GetSoundAlikeDetails(int p)
        {
            AlikeData objData = new AlikeData();
            PhrAlikeBO objBO = new PhrAlikeBO();
            objData.Code = txtcode.Text == "" ? "" : txtcode.Text;
            ...
            return objBO.SearchPhrSoundAlikeDetails(objData);
        }
