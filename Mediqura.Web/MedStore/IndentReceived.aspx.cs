...
{
    public partial class IndentReceived :BasePage
    {
        ...
        private void bindddl()
        {
            ...
            Commonfunction.PopulateDdl(ddl_substockrecv, mstlookup.GetLookupsList(LookupName.SubStockType));
            Commonfunction.PopulateDdl(ddl_RequestTypeRecv, mstlookup.GetLookupsList(LookupName.requestType));
            ddl_substockrecv.SelectedIndex = 1;
            // dropdown for tab 2
        ...
        protected void bindIndentRecvList()
        {
            try
            {
                ...
                List<IndentRecvHandOverData> objdeposit = bindIndentRecvList(0);
        ...
        public List<IndentRecvHandOverData> bindIndentRecvList(int curIndex)
        {
            ...
            objstock.SubStockID = Convert.ToInt32(ddl_substockrecv.SelectedValue == "" ? "0" : ddl_substockrecv.SelectedValue);
        ...
        protected void btnSaveRecv_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                objrec.XMLData = XmlConvertor.ReceivedRecordDatatoXML(List).ToString();
        ...
        protected void bindReceivedList()
        {
            try
            {
                ...
                List<IndentRecvHandOverData> objdeposit = GetRecvList(0);
                if (objdeposit.Count > 0)
                {
        ...
        public List<IndentRecvHandOverData> GetRecvList(int curIndex)
        {
            IndentRecvHandOverData objstock = new IndentRecvHandOverData();
            IndentRecvHandOverBO objBO = new IndentRecvHandOverBO();
            IFormatProvider option = new System.Globalization.CultureInfo("en-GB", true);
        ...
        {
            List<IndentRecvHandOverData> ReceivedDetails = GetRecvList(0);
            List<IndentHandOverDataToExcel> ListexcelData = new List<IndentHandOverDataToExcel>();
            int i = 0;
            foreach (IndentRecvHandOverData row in ReceivedDetails)
            {
