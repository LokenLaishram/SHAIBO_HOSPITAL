...
{
    public partial class LookAlikeMST : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          protected void btnsave_Click(object sender, EventArgs e)
         {
            try
           {
                ...
                int result = objBO.UpdatePhrLookAlikeDetails(objData);
          ...
          protected void GvLabMethodType_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Edits")
                {
                    ...
                    List<AlikeData> GetResult = objBO.GetPhrLookAlikeDetailsByID(objData);
                ...
                if (e.CommandName == "Deletes")
                {
                    ...
                    int Result = objBO1.DeletePhrLookDetailsByID(objData);
                    if (Result == 1)
                    {
